...
const ContactEdit = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    if (!e?.target?.photo?.value) return Swalert.fire('Error!', 'Please fill the Profile Pic URL!', 'error');
    // if(typeof e?.target?.age?.value !== 'number') return Swalert.fire('Error!', 'Age must be a number.', 'error');
    ...
    return dispatch(ContactAction.putContact(value));
  };
